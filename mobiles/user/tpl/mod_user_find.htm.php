...
<div class="typeli clearfix">
  <a href="javascript:void(0);" class="op" id="nextGrp" onclick="go_hashreq('#/explore,r='+parseInt(Math.random()*10000000));" >下一组</a>
</div>
...
<?php if ($it['type_id']=='word'):?>
      <div class="bbsizing typelist2 sharedata" data-type="<?=$it['type_id']?>" data-nid="<?=$it['nid']?>" data-content="<?=$it['content']?>" data-img="">
          ...
          <div class="typeset2 clearfix">
            ...
            <a href="javascript:void(0);" class="w25 share" onclick="return toSendNode(this,true);"><i class="sha"></i><span>分享</span></a>
          </div>
      </div>
  ...
  <div class="bbsizing typelist2 sharedata" data-type="<?=$it['type_id']?>" data-nid="<?=$it['nid']?>" data-content="<?=$it['content']?>" data-img="<?=$it['cover_url']?>">
      ...
      <div class="typeset2 clearfix">
        <a href="javascript:void(0);" onclick="action(<?=$it['nid']?>, 'love')" class="w25">
            ...
            <a href="javascript:void(0);" class="w25 share" onclick="return toSendNode(this,true);"><i class="sha"></i><span>分享</span></a></div>
  </div>

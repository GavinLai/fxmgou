...
;(function(c,d,f){c.handleError=function(s,a,b,e){if(s.error)s.error(a,b,e);else if(a.responseText)console.log(a.responseText)};c.uaMatch=function(a){a=a.toLowerCase();var b=/(chrome)[ \/]([\w.]+)/.exec(a)||/(webkit)[ \/]([\w.]+)/.exec(a)||/(opera)(?:.*version|)[ \/]([\w.]+)/.exec(a)||/(msie) ([\w.]+)/.exec(a)||a.indexOf("compatible")<0&&/(mozilla)(?:.*? rv:([\w.]+)|)/.exec(a)||[];return{browser:b[1]||"",version:b[2]||"0"}};if(!c.browser){matched=c.uaMatch(navigator.userAgent);var g={};if(matched.browser){g[matched.browser]=true;g.version=matched.version}if(g.chrome){g.webkit=true}else if(g.webkit){g.safari=true}c.browser=g}})(jQuery,this);

//: JavaScript Cookies
;(function(a){var b;if(typeof define==='function'&&define.amd){define(['jquery'],a)}else if(typeof exports==='object'){try{b=require('jquery')}catch(e){}module.exports=a(b)}else{var c=window.Cookies;var d=window.Cookies=a(window.jQuery);d.noConflict=function(){window.Cookies=c;return d}}}(function($){var g=/\+/g;function encode(s){return h.raw?s:encodeURIComponent(s)}function decode(s){return h.raw?s:decodeURIComponent(s)}function stringifyCookieValue(a){return encode(h.json?JSON.stringify(a):String(a))}function parseCookieValue(s){if(s.indexOf('"')===0){s=s.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,'\\')}try{s=decodeURIComponent(s.replace(g,' '));return h.json?JSON.parse(s):s}catch(e){}}function read(s,a){var b=h.raw?s:parseCookieValue(s);return isFunction(a)?a(b):b}function extend(){var a,options;var i=0;var b={};for(;i<arguments.length;i++){options=arguments[i];for(a in options){b[a]=options[a]}}return b}function isFunction(a){return Object.prototype.toString.call(a)==='[object Function]'}var h=function(a,b,c){if(arguments.length>1&&!isFunction(b)){c=extend(h.defaults,c);if(typeof c.expires==='number'){var d=c.expires,t=c.expires=new Date();t.setMilliseconds(t.getMilliseconds()+d*864e+5)}return(document.cookie=[encode(a),'=',stringifyCookieValue(b),c.expires?'; expires='+c.expires.toUTCString():'',c.path?'; path='+c.path:'',c.domain?'; domain='+c.domain:'',c.secure?'; secure':''].join(''))}var e=a?undefined:{},cookies=document.cookie?document.cookie.split('; '):[],i=0,l=cookies.length;for(;i<l;i++){var f=cookies[i].split('='),name=decode(f.shift()),cookie=f.join('=');if(a===name){e=read(cookie,b);break}if(!a&&(cookie=read(cookie))!==undefined){e[name]=cookie}}return e};h.get=h.set=h;h.defaults={};h.remove=function(a,b){h(a,'',extend(b,{expires:-1}));return!h(a)};if($){$.cookie=h;$.removeCookie=h.remove}return h}));
...
//: flib mobile
;(function($,w,k){w.String.prototype.trim=function(){return this.replace(/(^\s+)|(\s+$)/g,'')};w.String.prototype.ltrim=function(){return this.replace(/(^\s+)/g,'')};w.String.prototype.rtrim=function(){return this.replace(/(\s+$)/g,'')};w.String.prototype.isUrl=function(){return/(http(s?):\/\/)([\w-]+\.)+[\w:]{2,}(\/[\x00-\xff^]*)?/i.test(this);};w.String.prototype.isMobile=function(){return/^0?1[3458]\d{9}$/.test(this)};w.String.prototype.isEmail=function(){return/^\w+((-\w+)|(\.\w+))*\@[A-Za-z0-9]+((\.|-)[A-Za-z0-9]+)*\.[A-Za-z0-9]+$/.test(this)};w.String.prototype.qlike=function(a){var b=false;if(this==a){b=true}else if(this.match(F.genQRegex(a))){b=true}return b};var n=function(d){this.user={};this.data={};this.box={};this.queue={};this.location={};this.cache=new Array();this.cacheCtrl=new Array();this.hashData=new Array();this.qsSep=',';this.hashTag='/';this.hashReqId='_hr';this.hashUrlGenCallback=null;this.hashHist='hashhist';this.hashHistSize=10;this.defaultHash='#'+this.hashTag;this.cleanUrl=true;this.timer=null;this.maxage=60;this.container='#ifr-body';this.lang={loading:'数据加载中...',posting:'数据保存中...',saved:'数据已保存'};this.toploadingid='toploading';this.toploadingobj=null;this.topmainboxid='mainMsgBox';this.topmainboxobj=null;this.event={flag:{downpull:false},_events:{},on:function(a,b){if(!this._events[a]){this._events[a]=[]}this._events[a].push(b)},off:function(a,b){if(!this._events[a]){return}var c=this._events[a].indexOf(b);if(c>-1){this._events[a].splice(c,1)}},execEvent:function(a){if(!this._events[a]){return}var i=0,l=this._events[a].length;if(!l){return}for(;i<l;i++){this._events[a][i].apply(this,[].slice.call(arguments,1))}},reset:function(){this._events={};this.flag.downpull=false}};this.createQueue(this.hashHist,this.hashHistSize)};n.prototype={getCache:function(a){var d=this.cache[a];var t=this.time();if(d==k||t>=d.expires){d=''}return d},setCache:function(a,b){this.cache[a]=b},clearCache:function(a){this.cacheDirty(a)},clearCacheAll:function(){this.cache=new Array();this.cacheCtrl=new Array()},cacheDirty:function(a){var b=this.genCacheKey(a);var c=this.getCache(b);if(c){c.expires=this.time()-3600;this.setCache(b,c)}},genCacheKey:function(a){return hex_md5(a)},datetime:function(){var a=new Date();var Y=a.getFullYear();var m=a.getMonth()+1;var d=a.getDate();var H=a.getHours();var i=a.getMinutes();var s=a.getSeconds();if(m<10)m='0'+m;if(d<10)d='0'+d;if(H<10)H='0'+H;if(i<10)i='0'+i;if(s<10)s='0'+s;return''+Y+'-'+m+'-'+d+' '+H+':'+i+':'+s},time:function(){var a=new Date();return parseInt(a.getTime()/1000)},setTimer:function(a){this.timer=a},getTimer:function(a){return this.timer||null},createQueue:function(a,b){if(b==k||b<0||a==k||a==''){return false}this.queue[a]={container:[],size:b};return this.queue[a]},inQueue:function(a,b){if(a==k||a==''){return false}if(this.queue[a].container.length>=this.queue[a].size){this.queue[a].container.shift()}return this.queue[a].container.push(b)},outQueue:function(a){if(a==k||a==''){return false}var b=null;if(this.queue[a].container.length>0){b=this.queue[a].container.shift()}return b},indexQueue:function(a,b){if(a==k||a==''){return false}if(b==k){b=0}var c=null;if(b>=0){if(this.queue[a].container.length>b){c=this.queue[a].container[b]}}else{var d=this.queue[a].container.length;if(Math.abs(b)<=d){b=d+b;c=this.indexQueue(a,b)}}return c},clearQueue:function(a){if(a==k||a==''){return false}this.queue[a].container.length=0;return true},getQueueLen:function(a){if(a==k||a==''){return false}return this.queue[a].container.length},getQueueHead:function(a){if(a==k||a==''){return false}var b=null;if(this.queue[a].container.length>0){b=this.queue[a].container[0]}return b},getQueueEnd:function(a){if(a==k||a==''){return false}var b=null;var c=this.queue[a].container.length;if(c>0){b=this.queue[a].container[c-1]}return b},ajaxStart:function(a,b){if(a==k||(a!='load'&&a!='post')){a='load'}var c=this.lang.loading;if(a=='post'){c=this.lang.posting;if(!this.topmainboxobj)this.topmainboxobj=$('#'+this.topmainboxid);if(typeof b=='function'){b(this.topmainboxobj)}else{if(typeof b=='string'){c=b}this.topmainboxobj.find('span').text(c).attr('class','msg msg-loading');this.topmainboxobj.show()}}else{if(!this.toploadingobj)this.toploadingobj=$('#'+this.toploadingid);if(typeof b=='function'){b(this.toploadingobj)}else{if(typeof b=='string'){c=b}this.toploadingobj.find('span').text(c);this.toploadingobj.show()}}},ajaxComplete:function(a,b){if(a==k||(a!='load'&&a!='post')){a='load'}if(a=='post'){if(!this.topmainboxobj)this.topmainboxobj=$('#'+this.topmainboxid);if(typeof b=='function'){b(this.topmainboxobj)}else{var c=this.lang.saved;if(typeof b=='string'){c=b}this.topmainboxobj.find('span').attr('class','msg').text(c);var d=this;setTimeout(function(){d.topmainboxobj.fadeOut()},3000)}}else{if(!this.toploadingobj)this.toploadingobj=$('#'+this.toploadingid);if(typeof b=='function'){b(this.toploadingobj)}else{this.toploadingobj.hide()}}},ajax:function(a){$.ajax(a)},load:function(a,b,c){$.load(a,b,c)},get:function(a,b,c){$.get(a,b,c)},getScript:function(a,b){$.getScript(a,b)},getJSON:function(a,b,c,e,f){if(typeof b=='function'){f=e;e=c;c=b;b={}}else{b.maxage=b.maxage!=k?parseInt(b.maxage):this.maxage}var g=this.genCacheKey(a);var h=this.getCache(g);if(h&&b.maxage>0){c(h)}else{var i=this;if(this.cacheCtrl[g]==k){this.cacheCtrl[g]={ajaxing:0}}if(this.cacheCtrl[g].ajaxing){return}this.cacheCtrl[g].ajaxing=1;this.ajaxStart('load',e);$.getJSON(a,b,function(d){d.expires=F.time()+parseInt(d.maxage);i.setCache(g,d);i.cacheCtrl[g].ajaxing=0;i.ajaxComplete('load',f);c(d)})}},post:function(d,e,f,g,h){if(typeof e=='function'){h=g;g=f;f=e;e={}}var i=this;this.ajaxStart('post',g);$.ajax({url:d,type:'post',data:e,dataType:'json',success:function(a){i.ajaxComplete('post',h);f(a)},error:function(a,b,c){i.ajaxComplete('post',h)}})},hashReq:function(a,b,c,e){if(typeof b=='function'){e=c;c=b;b={}}b.maxage=b.maxage!=k?parseInt(b.maxage):this.maxage;b[this.hashReqId]=1;if(typeof e=='undefined'){e={}}e=$.extend({changeHash:true,forceRefresh:false,renderPrepend:'',renderAppend:''},e);var f='';if(a){var g=a;var h=a.indexOf('#');if(h>=0){g=a.substring(h)}else{g='#'+this.hashTag+a}this.inQueue(this.hashHist,{hash:g,data:b});f=this.parseHashUrl(g);if(e.changeHash)this.setHash(g)}else{f=w.location.href.replace(/#.*$/g,'')}if(e.forceRefresh){this.clearCache(f)}var i=this.genRealUrl(f,b);this.getJSON(f,b,function(d){d.body=e.renderPrepend+'<script type="text/javascript">F.location.hashreq=1;F.location.href=\''+i+'\';</script>'+d.body+e.renderAppend;c(d)});return false},hashLoad:function(c,d,e,f){if(typeof d=='function'){f=e;e=d;d={}}if(!c)c=w.location.hash;if(!c)c=this.defaultHash;if(this.isReqHash(c)){this.hashReq(c,d,function(a){var b=typeof(f.container)=='undefined'?$(F.container):(typeof f.container=='object'?f.container:$(f.container));b.html(a.body);if(typeof e=='function'){e(a)}},f)}return false},hashReload:function(){this.clearCacheAll();$(window).hashchange();return false},hashRefer:function(a,b){if(!a){var c=this.indexQueue(this.hashHist,-2);if(c)a=c.hash}if(b&&a){this.clearCache(this.parseHashUrl(a))}this.setHash(a);$(window).hashchange();return false},hashRedirect:function(a,b){if(!a)a=this.defaultHash;var c=a.indexOf('#');if(c<0)a='#'+a;if(b&&a){this.clearCache(this.parseHashUrl(a))}this.setHash(a);$(window).hashchange();return false},hashGo:function(a,b){return this.hashRedirect(a,b)},genQRegex:function(q){var a=q.replace(/%d/g,'(\\d+)');a=a.replace(/%s/g,'([0-9a-zA-Z_-]+)');return new RegExp('^'+a+'$')},genRealUrl:function(a,b){var c=a;if(b){var d='';for(var e in b){d+='&'+e+'='+b[e]}if(''!=d){d=d.substring(1);c+=(a.lastIndexOf('?')<0?'?':'&')+d}}return c},getHashReferUrl:function(a,b){var c=this.indexQueue(this.hashHist,-2);if(c){return this.genRealUrl(this.parseHashUrl(c.hash),c.data)}return''},isReqHash:function(a){return a.match(new RegExp('^#'+this.hashTag+'.*'))},parseHashUrl:function(a){var b='';var c=a.indexOf('#');if(c>=0){a=a.substring(c+2)}if(this.qsSep!='?'){a=a.replace(this.qsSep,'?')}var d=a.split('?');var b='/'+d[0];if(typeof this.hashUrlGenCallback=='function'){b=this.hashUrlGenCallback(d[0])}if(d.length>1&&d[1].trim()!=''){var e;d=d[1].split('&');for(var i=0,j=0;i<d.length;++i){e=d[i].split('=');if(e[0]=='maxage')continue;b+=(j==0&&this.cleanUrl?'?':'&')+d[i];++j}}return b},getHash:function(){var a=w.location.hash;return a?a:''},setHash:function(h){w.location.hash=h},locatePoint:function(a,b){var c=null;if(typeof a!='string'){c=a}else{c=document.getElementById(a)}if(c.setSelectionRange){setTimeout(function(){c.setSelectionRange(b,b);c.focus()},0)}else if(c.createTextRange){var d=c;var e=d.createTextRange();e.collapse(true);e.moveStart('character',b);e.select();setTimeout(function(){d.focus()},0)}},placeCaretAtEnd:function(a){a.focus();if(typeof window.getSelection!="undefined"&&typeof document.createRange!="undefined"){var b=document.createRange();b.selectNodeContents(a);b.collapse(false);var c=window.getSelection();c.removeAllRanges();c.addRange(b)}else if(typeof document.body.createTextRange!="undefined"){var d=document.body.createTextRange();d.moveToElementText(a);d.collapse(false);d.select()}},getBrowserWidth:function(){return window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth},getBrowserHeight:function(){return window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight},log:function(a){w.console.log(a)}};w.F=w.FUI=new n();w._gPop=null;w._gPopHtml=null;w._gWaitSucc=1;w._gWaitWarn=2;w._gWaitFail=3;var o=(function(){var b=[];var c=false;function handler(e){if(c)return;if(e.type==='onreadystatechange'&&document.readyState!=='complete'){return}for(var i=0;i<b.length;i++){b[i].call(document)}c=true;b=null}if(document.addEventListener){document.addEventListener('DOMContentLoaded',handler,false);document.addEventListener('readystatechange',handler,false);window.addEventListener('load',handler,false)}else if(document.attachEvent){document.attachEvent('onreadystatechange',handler);window.attachEvent('onload',handler)}return function o(a){if(c){a.call(document)}else{b.push(a)}}})();F.onDocReady=o})(jQuery,window);
